...
const sl_cr_pin_t right_motor_in1_pin   = SL_CR_PIN_DRIVE_MOTOR_1_IN1;
const sl_cr_pin_t right_motor_in2_pin   = SL_CR_PIN_DRIVE_MOTOR_1_IN2;
const sl_cr_pin_t right_motor_sleep_pin = SL_CR_PIN_DRIVE_MOTOR_1_SLEEP;
const sl_cr_pin_t right_encoder_a_pin   = SL_CR_PIN_DRIVE_ENCODER_1_A;
const sl_cr_pin_t right_encoder_b_pin   = SL_CR_PIN_DRIVE_ENCODER_1_B;
const sl_cr_pin_t left_motor_in1_pin    = SL_CR_PIN_DRIVE_MOTOR_2_IN1;
const sl_cr_pin_t left_motor_in2_pin    = SL_CR_PIN_DRIVE_MOTOR_2_IN2;
const sl_cr_pin_t left_motor_sleep_pin  = SL_CR_PIN_DRIVE_MOTOR_2_SLEEP;
const sl_cr_pin_t left_encoder_a_pin    = SL_CR_PIN_DRIVE_ENCODER_2_A;
const sl_cr_pin_t left_encoder_b_pin    = SL_CR_PIN_DRIVE_ENCODER_2_B;
