...
#ifndef __SL_ROBOT_CONTROL_LOOP_HPP__
#define __SL_ROBOT_CONTROL_LOOP_HPP__
...
namespace sandor_laboratories
{
  namespace robot
  {
    ...
    class control_loop_c : public control_loop_base_c
    {
      private:
        SETPOINT_T        sp;
        OUTPUT_T          output;
    ...
    template class control_loop_c<rpm_t,rpm_t>;
  }
}

#endif // __SL_ROBOT_CONTROL_LOOP_HPP__